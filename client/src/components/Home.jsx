...
const Home=()=>{
    ...
    const revealMsg=async()=>{
        try{
           const account = location.state.address; // fetch the account from the wallet page , as we have sent with tyhe navigate
    ...
    return(
    <>
        <span className="beautiful-sentence">I have a secret message for holders of my NFT collection with</span>
        <br></br>
        <br></br>
